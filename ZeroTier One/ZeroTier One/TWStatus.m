...
- (void)setupDefaultApperance{
    ...
    _statusWindow.backgroundColor = [UIColor colorWithRed:1.00 green:0.74 blue:0.42 alpha:1.00];
...
- (void)layoutForOrientation {
    ...
    CGAffineTransform t;
    CGRect frame;
    CGSize sizeAppFrame = [UIScreen mainScreen].bounds.size;
    switch (orientation) {
        default:
            NSLog(@"Warning - Unrecognised interface orientation (%ld)",(long)orientation);
